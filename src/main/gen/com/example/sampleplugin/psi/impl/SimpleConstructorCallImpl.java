...
public class SimpleConstructorCallImpl extends ASTWrapperPsiElement implements SimpleConstructorCall {
  ...
  @Override
  @NotNull
  public PsiElement getNewKw() {
    return findNotNullChildByType(NEW_KW);
  }
